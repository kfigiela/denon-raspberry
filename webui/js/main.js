...
MusicMode = React.createClass({
  render: function() {
    var currentSong;
    currentSong = this.props.data.mpd.song ? React.createElement("div", null, React.createElement("h1", null, this.props.data.mpd.song.artist), React.createElement("h2", null, this.props.data.mpd.song.title), React.createElement("h4", null, this.props.data.mpd.song.album)) : React.createElement("h1", null, "Stopped");
    return React.createElement("div", null, React.createElement("div", {
      "className": "btn-group btn-group-lg btn-group-justified"
    }, React.createElement(Button, {
      "onCommand": this.props.onCommand,
      ...
      "name": (this.props.data.mpd.status.state === "play" ? "fa-pause" : "fa-play")
    })), React.createElement(Button, {
      "onCommand": this.props.onCommand,
      "command": "mpd:next"
    }, React.createElement(Icon, {
